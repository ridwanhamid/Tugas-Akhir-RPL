...
?>
	...
	<div class="form-group">
		...
		<?php $sql1="SELECT kode_golongan,golongan FROM golongan_obat "; $query1=mysqli($sql1);  while ($data=mysqli($query1))
		{
	...
	<div class="form-group">
		...
		<?php $sql1="SELECT kode_jenis,nama_jenis FROM jenis_obat "; $query1=mysqli($sql1);  while ($data=mysqli($query1))
		{
	...
	<div class="form-group">
		...
		<?php $sql1="SELECT kode_bentuk,nama_bentuk FROM bentuk_obat "; $query1=mysqli($sql1);  while ($data=mysqli($query1))
		{
